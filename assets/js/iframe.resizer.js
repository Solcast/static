...
!(function (l) {
      ...
      (function (e) {
        ...
        return (
          window.top !== window.self &&
            (n = window.parentIFrame && window.parentIFrame.getId ? window.parentIFrame.getId() + ": " + e : "Nested host page: " + e),
          n
        );
      })(e) +
      "]"
  ...
  function n(n) {
      ...
      R(y, "Reposition requested from iFrame (offset x:" + n.x + " y:" + n.y + ")"),
        window.top !== window.self
          ? window.parentIFrame
            ...
            : E(y, "Unable to scroll to requested position, window.parentIFrame not found")
          : ((F = i), s(), R(y, "--"));
    }
    function s() {
    ...
    "[iFrameResizerChild]Ready" === p
      ...
      ? ((m = p.substr(x).split(":")),
        ...
        (y = b.id),
        M[y] && (M[y].loaded = !0),
        (l = b.type in { true: 1, false: 1, undefined: 1 }) && R(y, "Ignoring init message from meta parent page"),
        !l &&
          ((f = !0), M[(u = y)] || ((f = !1), E(b.type + " No settings for " + u + ". Message was: " + p)), f) &&
          (R(y, "Received: " + p),
          (c = !0),
            ...
            (function () {
              ...
              if (
                ...
                !(t.constructor === Array
                  ...
                  : ((e = M[y] && M[y].remoteHost), R(y, "Checking connection is from: " + e), i === e))
              )
                throw new Error(
              ...
              switch ((M[y] && M[y].firstRun && M[y] && (M[y].firstRun = !1), b.type)) {
                ...
                case "message":
                  !(function (e) {
                    R(y, "onMessage passed: {iframe: " + b.iframe.id + ", message: " + e + "}"),
                      d("onMessage", { iframe: b.iframe, message: JSON.parse(e) }),
                      R(y, "--");
                  })(t(6));
                  break;
                case "autoResize":
                ...
                case "inPageLink":
                  !(function (e) {
                    ...
                    o
                      ? ((n = r(o)), R(y, "Moving to in page link (#" + i + ") at x: " + n.x + " y: " + n.y), (F = { x: n.x, y: n.y }), s(), R(y, "--"))
                      : window.top !== window.self
                      ? window.parentIFrame
                        ? window.parentIFrame.moveToAnchor(i)
                        : R(y, "In page link #" + i + " not found and window.parentIFrame not found")
  ...
  function d(i, e) {
    ...
    var t,
      ...
      c =
        ("" === (o = i.id) &&
          ((i.id = ((t = (e && e.id) || w.id + m++), null !== document.getElementById(t) && (t += m++), (o = t))),
          (g = (e || {}).log),
    ...
    c in M && "iFrameResizer" in i
      ...
      : ((d = (d = e) || {}),
        (M[c] = { firstRun: !0, iframe: i, remoteHost: i.src && i.src.split("/").slice(0, 3).join("/") }),
        (function (e) {
        ...
        (function () {
          switch (
            (R(c, "IFrame scrolling " + (M[c] && M[c].scrolling ? "enabled" : "disabled") + " for " + c),
        ...
        ("number" != typeof (M[c] && M[c].bodyMargin) && "0" !== (M[c] && M[c].bodyMargin)) ||
          ((M[c].bodyMarginV1 = M[c].bodyMargin), (M[c].bodyMargin = M[c].bodyMargin + "px")),
        (r = L(c)),
        (s = p()) &&
          ((a = s),
          i.parentNode &&
